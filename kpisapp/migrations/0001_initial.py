    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trackingColecta', models.CharField(blank=True, max_length=255, null=True)),
                ('trackingDistribucion', models.CharField(blank=True, max_length=255, null=True)),
                ('trackingTransporte', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('tteSucursalDistribucion', models.CharField(blank=True, max_length=100, null=True)),
                ('tiendaEntrega', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('oms_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kpisapp.omsdata')),
                ('simpli_route_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kpisapp.simpliroutedata')),
            ],
        ),
    ]
